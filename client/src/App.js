...
import ErgastFunc from "./views/ErgastFunc";
        ...
        <Container>
          <Switch> 
            ...
            <ProtectedRoute exact path ="/example" token={this.state.token} 
                render={()=><Example/>} />
            <ProtectedRoute exact path ="/functionalexample" token={this.state.token} 
                render={()=><FunctionalExample/>} />
            <ProtectedRoute exact path ="/ergastfunc" token={this.state.token} 
                render={()=><ErgastFunc/>} />
            <ProtectedRoute exact path ="/shop" token={this.state.token} 
                render={()=><Shop addToCart={this.addToCart}/>} />

            <ProtectedRoute exact path ="/test" token={this.state.token} 
                render={()=><Test/>} />
